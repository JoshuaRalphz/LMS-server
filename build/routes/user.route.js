...
userRouter.get("/get-users", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin", "mentor"), user_controller_1.getAllUsers);
userRouter.put("/update-user", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin", "mentor"), user_controller_1.updateUserRole);
userRouter.delete("/delete-user/:id", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin", "mentor"), user_controller_1.deleteUser);
